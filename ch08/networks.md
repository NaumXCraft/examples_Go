...
```
| Преамбула + SFD |  MAC получателя  |  MAC отправителя  | EtherType | Полезная нагрузка ((Payload) | Padding (если нужно) |    FCS    |
| 7 байт + 1 байт |     6 байт       |       6 байт      |   2 байта |        46–1500 байт          |      до 46 байт      |   4 байта |
