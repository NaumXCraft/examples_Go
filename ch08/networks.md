...
| ------------------------------ | ---------------------------------------------------------------------  | ------------------------------------------------- |
| **VLAN/QoS/Коммутация**        | 802.1Q, 802.1p, Q-in-Q, STP (802.1D), RSTP/MSTP (802.1w/s), LACP (802.3ad/802.1AX) | VLAN-тегирование, предотвращение петель, QoS-приоритизация, агрегация портов. |
| **Служебные L2 протоколы**     | LLDP, CDP, ARP*, GARP, GVRP, MACsec, LACP (для динамической агрегации) | Автоопределение соседей, динамическое ARP, шифрование MAC, управление VLAN. |
| **PPP семейство**              | PPP, PPPoE, PPPoA, MLPPP                                               | Каналы «точка-точка», аутентификация, мультилинк для баланса. |
| **Классические WAN L2**        | HDLC, Frame Relay, ATM, SDLC                                           | Синхронная/асинхронная передача, виртуальные цепи, ячейки 53 байта в ATM. |
| **MPLS (между L2/L3)**         | MPLS, EoMPLS, VPLS                                                     | Передача по ярлыкам (labels), Ethernet over MPLS для L2 VPN. |
| **Беспроводные PAN (802.15)**  | Bluetooth (L2CAP), ZigBee (802.15.4), Thread, NFC                      | Личные сети: IoT-датчики, гарнитуры, низкое потребление энергии. |
| **Операторские L2 протоколы**  | DOCSIS (кабельный модем), GPON/EPON (пассивная оптика), Metro Ethernet (MEF) | Провайдерские сети: DOCSIS 3.1 до 10 Гбит/с, GPON до 2.5 Гбит/с симметрично. |
